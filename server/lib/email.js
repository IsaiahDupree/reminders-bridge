...
const EMAIL_FROM = process.env.EMAIL_FROM || 'RemindersBridge <onboarding@resend.dev>';
...
export function sendVerificationEmail(to, verifyUrl) {
  const subject = 'Verify your RemindersBridge email';
  ...
  <table role="presentation" style="max-width:480px;margin:0 auto;background:#181b22;border:1px solid #2a2f3a;border-radius:14px">
    <tr><td style="padding:28px 26px">
      ...
      <p style="color:#9aa1af;font-size:15px;line-height:1.5;margin:0 0 20px">Confirm this email to finish setting up your RemindersBridge account.</p>
      ...
      <p style="color:#6b7280;font-size:12px;margin:18px 0 0">If you didn't create a RemindersBridge account, you can ignore this email. This link expires in 24 hours.</p>
    </td></tr>
  </table></body></html>`;
  const text = `Verify your RemindersBridge email by opening this link (expires in 24h):\n${verifyUrl}\n\nIf you didn't sign up, ignore this email.`;
